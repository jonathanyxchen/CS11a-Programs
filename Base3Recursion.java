public class Base3Recursion{
    public static void main(String[] args){
      ...
      System.out.printf("Enter a number n and I'll convert it to Base3: %n");
      int n = s.nextInt(); s.nextLine();
      String b = convertToBase3(n);
      System.out.printf("%d base 10 is %s base 3%n",n,b);
    }

    public static String convertToBase3(int k){
